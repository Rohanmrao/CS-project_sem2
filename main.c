...
void viewdetails(void)
{
	...
	printf("-----------------------------------------------------------------------------");
	printf("\n1001\tRani Chennamma Express\tBoston to Manhattan\tRs.5000\t\t9am");
	printf("\n1002\tJanShatabdi Express\tManhattan To Boston\tRs.5000\t\t12pm");
	printf("\n1003\tRajyaRani Express\tBoston To L.A\t\tRs.4500\t\t8am");
	printf("\n1004\tSiddaganga Intercity\tL.A To Boston\t\tRs.4500\t\t11am");
	printf("\n1005\tVishwamanava Express\tBoston To Chicago\tRs.4000\t\t7am");
	printf("\n1006\tChamundi Express\tChicago To Boston\tRs.4000\t\t9.30am");
    printf("\n1007\tKaveri Express\t\tBoston To Washington\tRs.3500\t\t1pm");	
    printf("\n1008\tBasava Express\t\tWashington To Boston\tRs.3500\t\t4pm");
    printf("\n1009\tGolGumbaz Express\tBoston To Miami\t\tRs.6000\t\t3.35pm");
    printf("\n1009\tTippuSuperfast Express\tMiami To Boston\t\tRs.6000\t\t4.15pm");
